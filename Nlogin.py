...
#===========
                    ...
                    line.sendMessage(to,"(｡◕‿◕｡)\nบอทยังทำงานคับท่าน😁")
#===========
                elif "นับเลข" == msg.text.lower():
                    line.sendMessage(to,"『รอสักครู่ กำลังเริ่มนับ』")
...
#===========
                elif "ขายค่ะ" == msg.text.lower():
                    line.sendMessage(to,"🎀ธีม/ติ๊ก เหรียญแท้จากระบบ🎀\n10©=10บ./5 ฟรี 1/10 ฟรี 3\n50©=24บ.\n100©=48บ.\n150©=72บ.\n======================\n❇️สติ๊กเกอร์โปร ลดราคา ดูได้ที่ ไทม์ไลแม่ค้าได้ทุกวันค่ะ❇️\n======================\n🎀ชำระเงินได้ทาง🎀\n 0834526092 พร้อมเพล\n 0953911944 วอเลท\n======================\n🎀🎀🎀🎀🎀🎀🎀🎀\nสนใจ กดลิ้ง ทักแชทได้เลยค่ะ\nHttp://line.me/ti/p/ka_d-u3uc4")                    
#==============================================================================#
...
#==============FINNISHING PROTECT========================#
                ...
                if settings["changePictureProfile"] == True:
                    ...
                    line.sendMessage(to, "『ทำการเปลี่ยนรูป สำเร็จ』")
                if msg.toType == 2:
                         ...
                         if settings['detectMention'] == True:
                             ...
                             for mention in mentionees:
                                   if mention['M'] in lineMID:
                                          ...
                                          line.sendMessage(msg.to, None, contentMetadata={"STKID":"16675166","STKPKGID":"8588","STKVER":"13"}, contentType=7)
                                          break
                if msg.contentType == 0 and sender not in lineMID and msg.toType == 2:
                    if "MENTION" in list(msg.contentMetadata.keys()) != None:
